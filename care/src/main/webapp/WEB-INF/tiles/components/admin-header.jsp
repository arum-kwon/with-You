	...
	<div class="top-nav notification-row">
		...
		<ul class="nav pull-right top-menu">
			...
			<li id="mail_notificatoin_bar" class="dropdown"><a
				...
				<ul class="dropdown-menu extended inbox">
					...
					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="resources/admin/img/avatar-mini.jpg"></span> <span
							class="subject"> <span class="from">spayke</span> <span
								class="time">1 min</span>

						</span> <span class="message"> 결제가 되질않아요 </span>

					</a></li>

					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="resources/admin/img/avatar-mini2.jpg"></span> <span
							class="subject"> <span class="from">Bob Mckenzie</span> <span
								class="time">5 mins</span>

						</span> <span class="message"> 닉네임 변경가능한가요? </span>

					</a></li>

					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="resources/admin/img/avatar-mini3.jpg"></span> <span
							class="subject"> <span class="from">Phillip Park</span> <span
								class="time">2 hrs</span>

						</span> <span class="message"> 보호자가 불친절해요 </span>

					</a></li>

					<li><a href="#"> <span class="photo"><img
								alt="avatar" src="resources/admin/img/avatar-mini4.jpg"></span> <span
							class="subject"> <span class="from">Ray Munoz</span> <span
								class="time">1 day</span>

						</span> <span class="message"> 간병인이 불친절해요 </span>
			...
			<li class="dropdown"><a data-toggle="dropdown"
				...
				</span> <span class="adminname">관리자</span> <b class="caret"></b>
				...
				<ul class="dropdown-menu extended logout">
					...
					<li><a href="/withyoucare/adminlogin.do"><i
