...
<body>
  ...
  <section id="container" class="">
    ...
    <header class="header dark-bg">
      ...
      <!--logo start-->
      <a href="ad_home.do" class="logo">with <span class="lite">U</span></a>
      <!--logo end-->
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                <a href="/withyoucare/adminlogin.do"><i class="icon_key_alt"></i> Log Out</a>
              </li>
              <li>
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a class="" href="form_component.html">환자 가입</a></li>
              <li><a class="" href="form_validation.html">보호자 가입</a></li>
              <li><a class="" href="form_validation.html">간병인 가입</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;" class="">
